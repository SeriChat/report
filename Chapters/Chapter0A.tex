...
\chapter{Guide for Running SeriChat}{\label{app:poc}}
...
For each step you have to open a new terminal window and navigate to the folder where \texttt{SeriChat.jar} is located.
...
\begin{enumerate}
	...
	\\\textit{add a name for new member, -j (for join), name of group, and password} 
	\\\texttt{java -jar SeriChat.jar Bilal -j AU 123456}
\end{enumerate}

Step 2 and step 3 can be repeated for creating new groups and adding new group members.
